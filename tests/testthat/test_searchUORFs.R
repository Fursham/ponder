...
test_that("Test the value of outputs", {
  ...
  expect_equal(start(out$exons)[[1]][1:3], c(79854427, 79856504, 79858752)) 
  expect_equal(end(out$exons)[[1]][1:3], c(79854721, 79856534, 79858824)) 
  
  expect_equal(start(out$cds)[[1]], 79854489)
  expect_equal(end(out$cds)[[1]], 79854518)
